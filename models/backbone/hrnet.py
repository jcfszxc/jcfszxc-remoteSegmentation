...
__all__ = ['hrnetv2_18', 'hrnetv2_32', 'hrnetv2_48']


model_urls = {
      'hrnetv2_32': 'F:/DeepLearning/模型权重/HRNET/hrnetv2_w32_imagenet_pretrained.pth',
      'hrnetv2_48': 'F:/DeepLearning/模型权重/HRNET/hrnetv2_w48_imagenet_pretrained.pth'
}
...
def hrnetv2_18(pretrained=True, progress=True, **kwargs):
    r"""HRNet-18 model
    """
    return _hrnet('hrnetv2_18', pretrained, progress,
                   **kwargs)


def hrnetv2_32(pretrained=True, progress=True, **kwargs):
    r"""HRNet-32 model
    """
    return _hrnet('hrnetv2_32', pretrained, progress, **kwargs)


def hrnetv2_48(pretrained=True, progress=True, **kwargs):
    r"""HRNet-48 model
    """
    return _hrnet('hrnetv2_48', pretrained, progress, **kwargs)

if __name__ == '__main__':
#
    try:
        CKPT_PATH = os.path.join(os.path.abspath("."), 'F:/DeepLearning/模型权重/HRNET/hrnetv2_w32_imagenet_pretrained.pth')
